...
The complete statistical modeling, including data checks, data imputation, covariate screening, model selection, predictions and model summaries are all wrapped into the `ModelPoisson()` function. Only a control script and dataset are required. All of the output from the modeling is saved into summary folders and endpoint specific folders.
